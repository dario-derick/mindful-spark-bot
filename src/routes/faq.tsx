...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. You can delete individual journal entries any time. To delete your full account and all associated data, email mindful-spark-bot@support.tin.computer and we'll process the request promptly.",
  },
  {
  ...
  return (
    <MarketingShell>
      ...
      <p className="mt-12 text-center text-xs text-muted-foreground">
        Still have a question? Email <a className="underline hover:text-foreground" href="mailto:mindful-spark-bot@support.tin.computer">mindful-spark-bot@support.tin.computer</a>.
      </p>
    </MarketingShell>
  );
}
